...
{
    /// <summary>
    /// Utility class that provides easy access to the currently executing
    /// assembly's metadata. This class is  <see langword="static"/>.
    /// </summary>
    public static class AssemblyInfo
    {
        ...
        public static string VersionedTitle {
            ...
            get { return string.Format("{0} - v{1}", AssemblyInfo.Title, AssemblyInfo.Version); }
        }
