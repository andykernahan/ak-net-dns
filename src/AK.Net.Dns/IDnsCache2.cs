...
{
    /// <summary>
    /// Defines a mechanism for caching DNS information.
    /// </summary>
    /// <remarks>
    /// Implementations <b>MUST</b> be thread safe.
    /// </remarks>
    /// <threadsafety static="true" instance="true" />
    public interface IDnsCache2
    {
        /// <summary>
        /// ... the specified <paramref name="question"/>.
        /// </summary>
        ...
        /// </exception>
        DnsCacheResult2 Get(DnsQuestion question);
