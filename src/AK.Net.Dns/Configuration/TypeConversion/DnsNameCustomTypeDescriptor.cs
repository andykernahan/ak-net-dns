...
namespace AK.Net.Dns.Configuration.TypeConversion
{
    ...
    /// inherited.
    /// </summary>
    public sealed class DnsNameCustomTypeDescriptor : CustomTypeDescriptor
    {
        #region Public Interface.

        /// <summary>
        /// An instance of the DnsNameCustomTypeDescriptor class. This field is
        /// readonly.
        /// </summary>
        public static readonly DnsNameCustomTypeDescriptor Instance =
            new DnsNameCustomTypeDescriptor();
