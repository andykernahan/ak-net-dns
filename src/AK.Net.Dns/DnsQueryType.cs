...
{
    /// <summary>
    /// Defines the types of DNS queries.
    /// </summary>
    [Serializable]
    public enum DnsQueryType
    {
        /// <summary>
        /// A resource record which contains a host's IPv4 Internet Protocol
        /// address.
        /// </summary>
        A = 1,
        /// <summary>
        /// A resource record which identifies the authoritative name server for
        /// the domain.
        /// </summary>
        NS = 2,
        /// <summary>
        ...
        MB = 7,
        /// <summary>
        /// A resource record which specifies a mailbox which is a member of the
        /// mail group specified by the domain name.
        /// </summary>
        MG = 8,
        /// <summary>
        /// A resource record which specifies a mailbox which is the proper rename of
        ...
        Wks = 11,
        /// <summary>
        /// A resource record which identifies a pointer to another part of the
        /// domain name space.
        /// </summary>
        Ptr = 12,
        /// <summary>
        ...
        RT = 21,
        /// <summary>
        /// A resource record which contains a host's IPv6 Internet Protocol
        /// address.
        /// </summary>
        Aaaa = 28,
        /// <summary>
